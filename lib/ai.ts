...
export async function generateCards(article: Article): Promise<GenerateResult> {
  ...
  const system = [
    '당신은 한국어 카드뉴스 에디터입니다.',
    '주어진 기사 제목·요약문만으로 인스타그램 카드뉴스 5컷을 만듭니다.',
    '1) 표지(cover): 후킹되는 헤드라인 한 줄.',
    '2-4) 본문(body): 핵심 요지 한 문장씩, 제목 + 짧은 설명.',
    '5) 마지막(cta): 팔로우 유도 문구.',
  ...
  // Example: OpenAI-compatible Chat Completions. Adapt to your provider.
